...
st.sidebar.write(f"Your current balance is {ether_balance}ether")
##########################################
...
# from the20 appropriate drop-down menu. Then, enter the number of hours that you
